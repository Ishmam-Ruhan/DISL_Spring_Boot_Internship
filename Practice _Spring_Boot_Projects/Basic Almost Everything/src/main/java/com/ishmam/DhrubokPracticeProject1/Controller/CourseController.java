...
public class CourseController {
    ...
    @DeleteAPI("/delete/id/{id}")
    public ResponseEntity<Response> deleteCourse(@PathVariable BigInteger id){

        String message = courseService.deleteCourseWithId(id);

        return ResponseEntity
                .status(HttpStatus.OK)
                .body(new Response<>(
                        HttpStatus.OK,
                        "Delete Course with id: "+id+" Success!",
                        true,
                        message
                ));
    }
